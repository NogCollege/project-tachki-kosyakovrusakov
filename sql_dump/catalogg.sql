...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 15 2024 г., 13:41
...
CREATE TABLE `catalogg` (
  ...
  `categoria` set('Внедорожник','Бизнес','Премиум','Спорт','Комфорт') NOT NULL,
  `fullname` varchar(255) NOT NULL,
  `god` year NOT NULL,
  `Dvigatel` set('Бензин','Электро','Дизель') NOT NULL,
...
(1, 1, 'bmw', 'Ногинск', 'Внедорожник', 'BMW X2', 2021, 'Бензин', 2.3, 150, 10250, 9524, 8799, 'Абсолютно уникальный. Экстремально особенный. Новый BMW X2 заявляет о своих спортивных амбициях с первого взгляда. Его решительный атлетизм, динамика и маневренность делают его недосягаемым для конкурентов в своем классе. В сочетании с высококачественным интерьером и множеством инновационных технологий этот яркий экстраверт провозглашает наступление новой эры.'),
