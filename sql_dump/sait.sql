...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 01 2024 г., 09:51
...
CREATE TABLE `catalogg` (
  ...
  `categoria` set('Внедорожник','Бизнес','Премиум','Спорткар','Комфорт') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
